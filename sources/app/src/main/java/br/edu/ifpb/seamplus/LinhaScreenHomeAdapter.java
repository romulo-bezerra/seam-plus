...
public class LinhaScreenHomeAdapter extends ArrayAdapter<TempObject> {

    private final Context context;
    private final ArrayList<TempObject> elementos;

    public LinhaScreenHomeAdapter(Context context, ArrayList<TempObject> elementos) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.linha_screen_home, parent, false);
